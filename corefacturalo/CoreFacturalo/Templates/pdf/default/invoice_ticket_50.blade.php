...
<table class="full-width">
    ...
    <tr>
        <td class="text-center desc text-uppercase text-center">
            <br>
    ...
    <tr>
        <td class="text-center desc text-uppercase">
    ...
    <tr>
        <td class="ticket-50 text-center pt-2 border-top"><h5>{{ $document->document_type->description }}</h5></td>
    </tr>
    <tr>
        <td class="ticket-50 text-center pb-2 border-bottom"><h5>{{ $document_number }}</h5></td>
    </tr>
</table>
<table class="full-width">
    <tr>
        <td class="desc text-uppercase" colspan="2">
            F.Emisión: {{ $document->date_of_issue->format('Y-m-d') }} <br>
...
<table class="full-width mt-10 mb-10">
    ...
    <tbody>
    <tr>
        <td class="ticket-50 border-top-bottom desc text-left"></td>
        <td class="ticket-50 border-top-bottom desc text-left">UM</td>
        <td class="ticket-50 border-top-bottom desc text-left">DESCRIP.</td>
        <td class="ticket-50 border-top-bottom desc text-right" style="padding-right:5px;">P.UNIT</td>
        <td class="ticket-50 border-top-bottom desc text-right">TOTAL</td>
    </tr>
    @foreach($document->items as $row)
        ...
        <tr>
            <td colspan="5" class="ticket-50 border-bottom"></td>
        </tr>
    @endforeach
...
<table class="full-width">
    ...
    @foreach(array_reverse((array) $document->legends) as $row)
        ...
        @else
            ...
            <tr>
                <td class="ticket-50 text-center pt-2 border-top">
                    <img class="qr_code" src="data:image/png;base64, {{ $document->qr }}" style="max-width: 50%"/>
                </td>
            </tr>
            <tr>
                <td class="ticket-50 text-center desc text-uppercase border-bottom">Código Hash: {{ $document->hash }}</td>
            </tr>
