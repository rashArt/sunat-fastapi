...
<table class="full-width">
    ...
    <tr>
        <td class="ticket-58 text-center pt-2 border-top"><h5>{{ $document->document_type->description }}</h5></td>
    </tr>
    <tr>
        <td class="ticket-58 text-center pb-2 border-bottom"><h5>{{ $document_number }}</h5></td>
    </tr>
</table>
<table class="full-width">
    <tr>
