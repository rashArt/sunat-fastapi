...
<table class="full-width mt-10 mb-10">
    <thead class="">
    <tr class="bg-grey">
        <th class="border-top-bottom text-center py-2" class="cell-solid" width="6%">COD.</th>
        <th class="border-top-bottom text-center py-2" class="cell-solid" width="6%">CANT.</th>
        ...
        @if($show_series_column) <th class="border-top-bottom text-center py-2" class="cell-solid"> SERIE </th> @endif   
        @if($showModelColumn)
        ...
        <th class="border-top-bottom text-right py-2 col-total" class="cell-solid">P.UNIT</th>
        <th class="border-top-bottom text-right py-2" class="cell-solid" width="8%">DTO.</th>
        <th class="border-top-bottom text-right py-2 col-total" class="cell-solid">TOTAL</th>
    </tr>
    </thead>
    <tbody>
    @php
    ...
    @endforeach
        ...
        <tr>
            ...
            <td class="p-1 text-right align-top desc cell-solid-rl"></td>
            <td class="p-1 text-right align-top desc cell-solid-rl"></td>
            @if($show_series_column)<td class="p-1 text-right align-top desc cell-solid-rl"></td>@endif
            @if($showModelColumn)<td class="p-1 text-right align-top desc cell-solid-rl"></td>@endif
            @if($showBrandColumn)<td class="p-1 text-right align-top desc cell-solid-rl"></td>@endif
            @if($showLoteColumn)
                <td class="p-1 text-right align-top desc cell-solid-rl"></td>
                <td class="p-1 text-right align-top desc cell-solid-rl"></td>
            @endif
