    ...
    <table class="full-width mt-10 mb-10">
        <thead class="">
            <tr class="bg-grey">
                ...
                @if($showColumns['descuento']) <th class="border-top-bottom text-right py-2 pr-2" width="8%">DTO.</th> @endif
        ...
        <tbody>
            ...
            @foreach($document->items as $row)
            <tr>
                @if($showColumns['codigo']) <td class="text-center align-top">{{ $row->item->internal_id }}</td> @endif
                ...
                @endif
                @if($showColumns['precio_unitario'])
            ...
            <tr>
                ...
                @if($showColumns['modelo'] && $showModelColumn) <td></td> @endif
                @if($showColumns['marca'] && $showBrandColumn) <td></td> @endif
                @if($showColumns['lote'] && $showLoteColumn) <td></td> @endif
                @if($showColumns['fecha_vencimiento'] && $showLoteColumn) <td></td> @endif
                @if($showColumns['precio_unitario']) <td class="text-right align-top">-{{ number_format($p->total, 2) }}</td> @endif
                @if($showColumns['descuento']) <td class="text-right align-top">0</td> @endif
                @if($showColumns['total']) <td class="text-right align-top">-{{ number_format($p->total, 2) }}</td> @endif
            </tr>
            <tr>
                <td colspan="{{ $colspan_total }}" class="border-bottom"></td>
            </tr>
            ...
            <tr>
                <td colspan="{{ $colspan_total - 1 }}" class="text-right font-bold pr-2">OP. EXPORTACIÓN: {{ $document->currency_type->symbol }}</td>
                <td class="text-right font-bold">{{ number_format($document->total_exportation, 2) }}</td>
            </tr>
            @endif
            @if($document->total_free > 0)
            <tr>
                <td colspan="{{ $colspan_total - 1 }}" class="text-right font-bold pr-2">OP. GRATUITAS: {{ $document->currency_type->symbol }}</td>
                <td class="text-right font-bold">{{ number_format($document->total_free, 2) }}</td>
            </tr>
            @endif
            @if($document->total_unaffected > 0)
            <tr>
                <td colspan="{{ $colspan_total - 1 }}" class="text-right font-bold pr-2">OP. INAFECTAS: {{ $document->currency_type->symbol }}</td>
                <td class="text-right font-bold">{{ number_format($document->total_unaffected, 2) }}</td>
            </tr>
            @endif
            @if($document->total_exonerated > 0)
            <tr>
                <td colspan="{{ $colspan_total - 1 }}" class="text-right font-bold pr-2">OP. EXONERADAS: {{ $document->currency_type->symbol }}</td>
            ...
            <tr>
                <td colspan="{{ $colspan_total - 1 }}" class="text-right pr-2">OP. GRAVADAS: {{ $document->currency_type->symbol }}</td>
            ...
            @endphp
            <tr>
                <td colspan="{{ $colspan_total - 1 }}" class="text-right font-bold pr-2">CARGOS ({{$total_factor}}
                    %): {{ $document->currency_type->symbol }}</td>
                <td class="text-right font-bold">{{ number_format($document->total_charge, 2) }}</td>
            </tr>
            @else
            <tr>
                <td colspan="{{ $colspan_total - 1 }}" class="text-right font-bold pr-2">CARGOS: {{ $document->currency_type->symbol }}</td>
                <td class="text-right font-bold">{{ number_format($document->total_charge, 2) }}</td>
            </tr>
            @endif
            @endif
            ...
            <tr>
                <td colspan="{{ $colspan_total - 1 }}" class="text-right font-bold pr-2">IMPORTE TOTAL: {{ $document->currency_type->symbol }}</td>
                <td class="text-right font-bold">{{ number_format($document->total, 2) }}</td>
            </tr>
            <tr>
                <td colspan="{{ $colspan_total - 1 }}" class="text-right font-bold pr-2">PERCEPCIÓN: {{ $document->currency_type->symbol }}</td>
            ...
            <tr>
                <td colspan="{{ $colspan_total - 1 }}" class="text-right font-bold pr-2"
            ...
            <tr>
                <td colspan="{{ $colspan_total - 1 }}" class="text-right pr-2">TOTAL RETENCIÓN ({{ $document->retention->percentage * 100 }}
                    %): {{ $document->currency_type->symbol }}</td>
                <td class="text-right">{{ number_format($document->retention->amount, 2) }}</td>
            </tr>
            <tr>
                <td colspan="{{ $colspan_total - 1 }}" class="text-right pr-2">IMPORTE NETO: {{ $document->currency_type->symbol }}</td>
            ...
            @if($balance < 0)
            <tr>
                <td colspan="{{ $colspan_total - 1 }}" class="text-right font-bold pr-2">VUELTO: {{ $document->currency_type->symbol }}</td>
