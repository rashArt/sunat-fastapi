...
<table class="full-width mt-10 mb-10">
    ...
    <tr class="bg-grey">
        ...
        @if($showColumns['precio_unitario']) <th class="border-top-bottom text-right py-2" width="12%">P.UNIT</th> @endif
        @if($showColumns['descuento']) <th class="border-top-bottom text-right py-2" width="8%">DTO.</th> @endif
        @if($showColumns['total']) <th class="border-top-bottom text-right py-2" width="12%">TOTAL</th> @endif
    </tr>
    </thead>
    <tbody>
    @php
    ...
    @foreach($document->items as $row)
        <tr>
            ...
            <td class="text-center align-top">{{ $row->item->unit_type_id }}</td> @endif
            ...
            <td class="text-right align-top">{{ number_format($row->unit_price, 2) }}</td> @endif
            ...
            <td class="text-right align-top">{{ number_format($row->total, 2) }}</td> @endif
        </tr>
        <tr>
