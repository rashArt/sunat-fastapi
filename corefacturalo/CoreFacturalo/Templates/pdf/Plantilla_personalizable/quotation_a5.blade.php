...
<table class="full-width mt-10 mb-10">
    <thead class="">
    <tr class="bg-grey">
        @if($showColumns['cantidad']) <th class="border-top-bottom text-center py-2" width="8%">CANT.</th>
        @endif
        @if($showColumns['unidad']) <th class="border-top-bottom text-center py-2" width="8%">UNIDAD</th>
        @endif
        @if($showColumns['descripcion']) <th class="border-top-bottom text-left py-2">DESCRIPCIÓN</th>
        @endif
