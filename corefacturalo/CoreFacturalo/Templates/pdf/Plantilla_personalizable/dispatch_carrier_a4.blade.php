...
<table class="full-width border-box mt-10 mb-10">
    ...
    @if($document->payer)
    <tr>
        <td>Datos del Pagador de Flete: {{ $document->payer['description'] }}
            - {{ $document->payer['name'] }} - {{ $document->payer['identity_document_type_description'] }} {{ $document->payer['number'] }}</td>
    </tr>
    @endif
    </tbody>
</table>
...
<table class="full-width border-box mt-10 mb-10">
    ...
    <tr>
        ...
        <th class="border-top-bottom text-right" width="9%">Cantidad</th>
    </tr>
    </thead>
    <tbody>
    @foreach($document->items as $row)
