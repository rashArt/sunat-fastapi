...
<table class="full-width mt-10 mb-10">
    <thead class="">
    <tr class="bg-grey">
        @if($showColumns['codigo']) <th class="border-top-bottom text-center py-2" width="6%">COD.</th> @endif
        @if($showColumns['cantidad']) <th class="border-top-bottom text-center py-2" width="6%">CANT.</th> @endif
        @if($showColumns['unidad']) <th class="border-top-bottom text-center py-2" width="7%">UNIDAD</th> @endif
        ...
        @endif
        @if($showColumns['lote'] && $showLoteColumn) <th class="border-top-bottom text-center py-2" width="12%">
             LOTE 
        </th> @endif
        @if($showColumns['lote'] && $showLoteColumn) <th class="border-top-bottom text-center py-2" width="9%"> F. VENC. </th> @endif
        @if($showColumns['precio_unitario']) <th class="border-top-bottom text-right py-2 col-total">P.UNIT</th> @endif
        @if($showColumns['descuento']) <th class="border-top-bottom text-right py-2 pr-2" width="7%">DTO.</th> @endif
    ...
    <tbody>
        ...
        <tr>
            ...
            @if($showColumns['descripcion']) <td class="text-left align-top">
            ...
            @if($showColumns['descuento']) <td class="text-right align-top pr-2">
                @if($row->discounts)
                    @php
    ...
    @if ($document->document_type_id === '07')
        @if($document->total_taxed >= 0)
            <tr>
                <td colspan="{{ $colspan_total - 1 }}" class="text-right font-bold pr-2">OP. GRAVADAS: {{ $document->currency_type->symbol }}</td>
    ...
    @endif
    <tr>
        <td colspan="{{ $colspan_total - 1 }}" class="text-right font-bold pr-2">IGV: {{ $document->currency_type->symbol }}</td>
